...
public class FirstNote {
	...
	public static Note createFirstNote() {
		...
		note.setTitle("PrivateNotes' first note");
		
		note.setGuid(UUID.randomUUID().toString());//"8f837a99-c920-4501-b303-6a39af57a714");
	...
	private static final String BUNDLE_NAME = "org.privatenotes.util.FirstNote";
