...
import org.privatenotes.sync.WebDAV.WebDAVSyncService;
import org.privatenotes.sync.sd.SdCardSyncService;
import org.privatenotes.sync.web.SnowySyncMethod;
...
public class SyncManager {
	...
	private void createSyncMethods() {
		...
		try {
			syncMethods.add(new WebDAVSyncService(activity, handler));
		} catch (FileNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
