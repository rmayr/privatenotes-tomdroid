/***
 * Thanks to:
 * http://stackoverflow.com/questions/3962911/bouncycastle-pgp-decryption-correct-size-but-all-blank
 * user "dstarh"
 */
...
public class PgpEncryption {
	...
	public static void runTest() {
		try {
			...
			FileInputStream fin = new FileInputStream(new File(extStore, "/tomdroidTest/encrypted.gpg"));
			
			FileInputStream keyin = new FileInputStream(new File(extStore, "/tomdroidTest/sec.keys"));
			byte[] clear = PgpEncryption.decrypt(fin, keyin, "shjzoef8".toCharArray());
			Log.e("IMPORTAAANT:", "dec result: " + new String(clear));
		} catch (Exception e) {
			Log.e("IMPORTAAANT", "blew up!", e);
		}
	}
    ...
    private static PGPPrivateKey findSecretKey(
        ...
        return pgpSecKey.extractPrivateKey(pass, Util.SECURITY_PROVIDER_ID);
    }
     ...
     */
    public static byte[] decrypt(InputStream encrypted, InputStream keyIn, char[] password)
        ...
        InputStream clear = pbe.getDataStream(sKey, Util.SECURITY_PROVIDER_ID);
